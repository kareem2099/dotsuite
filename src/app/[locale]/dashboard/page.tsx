    ...
    <div className="min-h-screen">
      ...
      <div className="w-full max-w-400 mx-auto px-6 md:px-12 lg:px-20 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
          ...
          <Link
            href={`/${locale}/product/dotscramble`}
            className="p-6 bg-(--card-bg) border border-(--card-border) rounded-xl hover:border-blue-500/50 transition-colors group"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold">DotScramble</h3>
                <p className="text-sm text-(--text-muted)">Manage image privacy</p>
              </div>
            </div>
          </Link>

          <Link
            href={`/${locale}/dashboard/dotaegis`}
            className="p-6 bg-(--card-bg) border border-(--card-border) rounded-xl hover:border-emerald-500/50 transition-colors group"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold">DotAegis</h3>
                <p className="text-sm text-(--text-muted)">AI Secret Scanner & Shield</p>
              </div>
            </div>
          </Link>
