  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <Link
          href={`/${locale}/product`}
          className="inline-flex items-center gap-2 text-sm text-(--text-muted) hover:text-[#10b981] transition-colors mb-8"
        >
        ...
        <div className="p-8 bg-(--card-bg) border border-(--card-border) rounded-xl mb-6">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
            <div className="flex-1">
              <span className="inline-block text-xs px-2 py-1 bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20 rounded-full capitalize mb-3">
                {product.category}
              </span>
              ...
              <div className="flex flex-wrap items-center gap-4 mt-4 text-sm text-(--text-muted)">
                ...
                {/* Version */}
                <span className="px-2 py-0.5 bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20 rounded-full text-xs">
            ...
            <div className="flex flex-col gap-3 min-w-48">
              <a
                ...
                className="flex items-center justify-center gap-2 px-4 py-3 bg-[#10b981] text-[#0a0a0a] font-semibold rounded-lg hover:bg-[#059669] transition-colors text-sm"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 px-4 py-3 border border-(--card-border) text-(--foreground) rounded-lg hover:border-[#10b981] hover:text-[#10b981] transition-colors text-sm"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
